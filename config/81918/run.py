...
# test_dir = "val_image"
create_txt(data_root, train_imgs_dir, train_labels_dir, test_dir=None, val_pro=0.2)


os.system('python  /home/aistudio/PaddleSeg/train.py --config /home/aistudio/config/81918/ocrnet.yml --do_eval --use_vdl --save_dir /home/aistudio/models/81918 --save_interval 10000')