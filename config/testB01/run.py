...
test_dir = None
create_txt(data_root, train_imgs_dir, train_labels_dir, test_dir, val_pro=0.1)

import os
os.system('python PaddleSeg/train.py --config config/testB01/ocrnet.yml --do_eval --use_vdl --save_dir /home/aistudio/models/testB01 --save_interval 5000')