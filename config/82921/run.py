...
# test_dir = "val_image"
create_txt(data_root, train_imgs_dir, train_labels_dir, test_dir=None, val_pro=0.05)



# os.system('CUDA_VISIBLE_DEVICES=0,1,2,3 python -u -m paddle.distributed.launch PaddleSeg/train.py --config muiltcard.yml --do_eval --use_vdl --save_dir /root/paddlejob/workspace/output --save_interval 10000')

os.system('python  /home/aistudio/PaddleSeg/train.py --config /home/aistudio/config/82921/multicard.yml --do_eval --use_vdl --save_dir /home/aistudio/models/82921 --save_interval 10000')
